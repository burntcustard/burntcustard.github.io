...
description: There have been tons of usful additions to CSS over the last year or so - some of them are super helpful for js13kGames!
date: 2022-08-13
---
...
{% codepen "https://codepen.io/burntcustard/pen/gOeBwPy" %}
...
{% codepen "https://codepen.io/burntcustard/pen/wvmEVOo" "tabs:css,result" %}
...
{% codepen "https://codepen.io/burntcustard/pen/jOzerZg" "tabs:css,result" %}
...
{% codepen "https://codepen.io/burntcustard/pen/WNzaxxL" "tabs:css,result" %}

This CSS-based city uses the effect to [miniture-ify](https://en.wikipedia.org/wiki/Miniature_faking) it:

{% codepen "https://codepen.io/burntcustard/pen/GRxYZQW" "preview:true;height:450" %}
